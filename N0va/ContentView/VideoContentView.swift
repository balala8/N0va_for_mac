...
fileprivate class VideoSharePlayer: NSObject {
    ...
    @objc func add_video(){
        let urlwithPercentEscapes = self.luming.get_net_url().addingPercentEncoding( withAllowedCharacters: .urlQueryAllowed)
        ...
        self.queuePlayer.insert(item, after: self.queuePlayer.items().last)
    ...
    func loadUrl(_ url: URL) {
        ...
        self.queuePlayer.isMuted = (UserDefaults.standard.integer(forKey: "mute")==1)
        self.add_video()
